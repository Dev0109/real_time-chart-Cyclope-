...
$ft->define(array('main' => "print.html"));
 ...
 */
$ft->assign('XPRINT',include(CURRENT_VERSION_FOLDER.'php/ajax/xprint.php'));
...
$bottom_includes.='<script type="text/javascript">flobn.register("genesis",new Date("'.date('n/j/Y',$dates['genesis']).'"));</script><script type="text/javascript" src="ui/print-ui.js"></script>';

$export_header = get_export_header($glob['f']);
extract($export_header,EXTR_OVERWRITE);
$glob['append'] = trialEncrypt($member_name);

$ft->assign('PAGE_TITLE',$ft->lookup('Print for'));
